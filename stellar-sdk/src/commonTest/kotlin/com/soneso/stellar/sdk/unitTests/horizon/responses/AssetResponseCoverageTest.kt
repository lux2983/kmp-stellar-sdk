...
class AssetResponseCoverageTest {
    ...
    fun testAssetResponseWithNullableFields() {
        ...
        // Test all properties with null values
        ...
        // Test Accounts inner class with zeros
        ...
        // Test Balances inner class with zeros
        ...
        // Test Flags inner class with different values
        ...
        // Test Links inner class without templated field
    ...
    fun testAssetResponseInnerClassesDirectConstruction() {
        // Test direct construction of Accounts inner class
        ...
        // Test direct construction of Balances inner class
        ...
        val links = AssetResponse.Links(
            toml = com.soneso.stellar.sdk.horizon.responses.Link("https://direct.test/toml", true)
        )

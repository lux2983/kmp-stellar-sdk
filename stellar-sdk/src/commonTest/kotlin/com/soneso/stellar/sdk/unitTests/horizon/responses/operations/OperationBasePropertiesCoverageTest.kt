...
/**
 * Comprehensive tests to achieve 100% code coverage for all OperationResponse classes.
 * 
 * The purpose of these tests is specifically to access all base properties (id, sourceAccount, etc.)
 * and specific properties of each operation response class to ensure that all property getters
 * are executed, covering the bytecode for the `override val` declarations.
 */
class OperationBasePropertiesCoverageTest {

...
[![Version](https://img.shields.io/badge/version-1.1.0-blue)](https://github.com/Soneso/kmp-stellar-sdk/releases)
...
dependencies {
    implementation("com.soneso.stellar:stellar-sdk:1.1.0")
}
```
